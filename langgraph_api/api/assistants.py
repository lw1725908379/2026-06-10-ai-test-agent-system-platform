...
# pragma: no cover  MC80OmFIVnBZMlhsaUpqbWxvYzZRMFJ3WkE9PTphODhiNGJiYg==
...
def _graph_schemas(graph: Pregel) -> dict:
    ...
    if USE_RUNTIME_CONTEXT_API:
        ...
        context_schema = None
# pylint: disable  MS80OmFIVnBZMlhsaUpqbWxvYzZRMFJ3WkE9PTphODhiNGJiYg==
...
async def get_assistant_subgraphs(
    ...
    async with connect() as conn:
        assistant_ = await CrudAssistants.get(conn, assistant_id)
        assistant = await fetchone(assistant_)
# pylint: disable  Mi80OmFIVnBZMlhsaUpqbWxvYzZRMFJ3WkE9PTphODhiNGJiYg==
...
# noqa  My80OmFIVnBZMlhsaUpqbWxvYzZRMFJ3WkE9PTphODhiNGJiYg==
