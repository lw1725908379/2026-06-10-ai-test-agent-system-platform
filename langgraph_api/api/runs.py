...
# type: ignore  MC80OmFIVnBZMlhsaUpqbWxvYzZabHB0Y2c9PTo3MWM2YmI5ZQ==
...
async def stream_run_stateless(
    ...
    try:
        ...
        await sub.__aexit__(None, None, None)
        raise
# pylint: disable  MS80OmFIVnBZMlhsaUpqbWxvYzZabHB0Y2c9PTo3MWM2YmI5ZQ==
...
async def wait_run_stateless(request: ApiRequest):
    ...
    async def stateless_fallback() -> bytes:
        ...
        return b"{}"
# type: ignore  Mi80OmFIVnBZMlhsaUpqbWxvYzZabHB0Y2c9PTo3MWM2YmI5ZQ==
...
# type: ignore  My80OmFIVnBZMlhsaUpqbWxvYzZabHB0Y2c9PTo3MWM2YmI5ZQ==
