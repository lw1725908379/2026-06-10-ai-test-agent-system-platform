...
import structlog
# pylint: disable  MC8zOmFIVnBZMlhsaUpqbWxvYzZOR0pTY3c9PTphNjI4ODA2ZQ==
...
# pragma: no cover  MS8zOmFIVnBZMlhsaUpqbWxvYzZOR0pTY3c9PTphNjI4ODA2ZQ==
...
async def call_webhook(result: "WorkerResult") -> None:
    if HTTP_CONFIG and HTTP_CONFIG.get("disable_webhooks"):
        ...
        return
# pragma: no cover  Mi8zOmFIVnBZMlhsaUpqbWxvYzZOR0pTY3c9PTphNjI4ODA2ZQ==
