# pragma: no cover  MC8zOmFIVnBZMlhsaUpqbWxvYzZjRTF6WVE9PTo1YzFmN2E3MQ==
...
# fmt: off  MS8zOmFIVnBZMlhsaUpqbWxvYzZjRTF6WVE9PTo1YzFmN2E3MQ==
...
class PrivateNetworkMiddleware(BaseHTTPMiddleware):
    ...
    * https://developer.chrome.com/blog/private-network-access-update-2024-03
    ...
    def __init__(self, app: ASGIApp):
        ...
        super().__init__(app)
# pragma: no cover  Mi8zOmFIVnBZMlhsaUpqbWxvYzZjRTF6WVE9PTo1YzFmN2E3MQ==
