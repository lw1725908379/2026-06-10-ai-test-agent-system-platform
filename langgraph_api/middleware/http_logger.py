...
# fmt: off  MC80OmFIVnBZMlhsaUpqbWxvYzZXRVZpWVE9PTphODhkNGViMw==
...
# pragma: no cover  MS80OmFIVnBZMlhsaUpqbWxvYzZXRVZpWVE9PTphODhkNGViMw==
...
# pragma: no cover  Mi80OmFIVnBZMlhsaUpqbWxvYzZXRVZpWVE9PTphODhkNGViMw==
...
def _headers_to_dict(headers: list[tuple[bytes, bytes]] | None) -> dict[str, str]:
    if headers is None:
        return {}
# pylint: disable  My80OmFIVnBZMlhsaUpqbWxvYzZXRVZpWVE9PTphODhkNGViMw==
