...
# pylint: disable  MC80OmFIVnBZMlhsaUpqbWxvYzZWRnBEZVE9PTpiZjIxOTQyNA==
...
# pragma: no cover  MS80OmFIVnBZMlhsaUpqbWxvYzZWRnBEZVE9PTpiZjIxOTQyNA==
...
async def collect_store_from_env() -> None:
    ...
    CUSTOM_STORE = value
# pylint: disable  Mi80OmFIVnBZMlhsaUpqbWxvYzZWRnBEZVE9PTpiZjIxOTQyNA==
...
def _load_store(store_path: str) -> Any:
    ...
    return store
# type: ignore  My80OmFIVnBZMlhsaUpqbWxvYzZWRnBEZVE9PTpiZjIxOTQyNA==
