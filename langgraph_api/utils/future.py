...
# pylint: disable  MC80OmFIVnBZMlhsaUpqbWxvYzZTM2RZVHc9PTpmMjMxZGY1NQ==
...
# fmt: off  MS80OmFIVnBZMlhsaUpqbWxvYzZTM2RZVHc9PTpmMjMxZGY1NQ==
...
def chain_future(source: AnyFuture, destination: AnyFuture) -> AnyFuture:
    ...
    try:
        ...
        if isinstance(destination, concurrent.futures.Future):
            ...
            destination.set_exception(exc)
        raise
# type: ignore  Mi80OmFIVnBZMlhsaUpqbWxvYzZTM2RZVHc9PTpmMjMxZGY1NQ==
...
def _ensure_future(
    ...
    *,
    ...
    try:
        ...
        raise
# pylint: disable  My80OmFIVnBZMlhsaUpqbWxvYzZTM2RZVHc9PTpmMjMxZGY1NQ==
