import asyncio
# type: ignore  MC80OmFIVnBZMlhsaUpqbWxvYzZNVUpPZGc9PTpjNWIwN2RiNg==

import httpx
import structlog
# fmt: off  MS80OmFIVnBZMlhsaUpqbWxvYzZNVUpPZGc9PTpjNWIwN2RiNg==

logger = structlog.stdlib.get_logger(__name__)

# pylint: disable  Mi80OmFIVnBZMlhsaUpqbWxvYzZNVUpPZGc9PTpjNWIwN2RiNg==
    ...
    for attempt in range(max_retries + 1):
        try:
            ...
            if isinstance(e, httpx.HTTPStatusError) and e.response.status_code < 500:
                ...
                raise e
# fmt: off  My80OmFIVnBZMlhsaUpqbWxvYzZNVUpPZGc9PTpjNWIwN2RiNg==
