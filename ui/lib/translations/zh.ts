...
export const translations = {
  ...
  nav: {
    ...
    apiTests: "API 测试",
    webTests: "Web 测试",
    androidTests: "Android 测试",
    pentest: "渗透测试",
    scenarioTests: "场景测试",
    testRuns: "测试运行",
    testPlans: "测试计划",
    reports: "测试报告",
    fullstackAnalysis: "全栈分析",
    settings: "设置",
    selectProject: "选择项目",
  },
...
5. 保存测试成果到数据库`,
  ...
  androidTests: {
    ...
    assertions: "断言",
    parseApp: "解析应用",
    parseFromApk: "从 APK 解析",
    parseFromPackage: "从包名解析",
    runTest: "运行测试",
    runAll: "运行全部",
    testResult: "测试结果",
    requestDetails: "请求详情",
    ...
    orchestrationViewDesc: "在流程编排视图中可以创建和编辑用户操作流程",
    // AI 助手
    androidTestAssistant: "Android测试生成助手",
    flowTestAssistant: "流程测试生成助手",
    aiAssistant: "AI 助手",
    // 其他 UI 文本
    parseAndroid: "Android 解析",
    orchestrate: "编排",
    monitor: "监控",
    openAIAssistant: "打开 AI 助手",
    // Android 测试界面
    ...
    subFunctionsCount: "个子功能",
    flowsCount: "个流程",
    androidFunctionAssistant: "Android功能助手",
    // 消息提示
    loadAndroidTestsFailed: "加载Android测试失败",
    loadAndroidFunctionsFailed: "加载Android功能失败",
    loadFlowsFailed: "加载流程失败",
    executeTestPrompt: "请执行测试脚本",
    folderNameRequired: "请输入文件夹名称",
    folderUpdateSuccess: "文件夹更新成功",
    ...
    testArtifactsForFunction: "显示 {name} 的测试成果物",
    noFunctionData: "暂无功能数据",
    selectFolderOrImportAndroid: "请先在左侧选择文件夹或创建Android功能",
    selectFolderOrImportApp: "请先在左侧选择文件夹或导入应用信息",
    editFolder: "编辑文件夹",
    createFolder: "新建文件夹",
    editFolderInfo: "修改文件夹信息",
    createNewFolder: "创建一个新的文件夹",
    ...
    deleteFolderMessage: "确定要删除文件夹 \"{name}\" 吗？此操作将同时删除该文件夹下的所有子文件夹和内容，且无法恢复。",
    generateTestsForFunction: "请为子功能 {id} 生成测试",
    generateTestsForNewFunction: "请帮我创建一个新的Android功能并生成测试",
    // Android 功能列表
    noFunctionsInFolder: "该文件夹下还没有解析的 Android 功能",
    clickToImportApp: "点击右上角的\"Android 解析\"按钮来导入应用信息",
    // Android 功能侧边栏
    functionDetails: "功能详情",
    loadingFunctionDetails: "加载功能详情中...",
    functionNotFound: "未找到功能信息",
...
- 包含设备旋转测试场景
- 测试不同分辨率下的 UI 适配`,
    autoGenerateNote: "如果不填写，AI 将根据应用定义自动生成标准的测试计划、测试用例和测试脚本。",
    saving: "保存中...",
    editInfo: "编辑信息",
    aiGenerateTest: "AI 生成测试",
    confirmDeleteFunction: "确认删除功能",
    confirmDeleteFunctionMessage: "您确定要删除功能 {name} 吗？",
    deleteFunctionTitle: "删除 Android 功能",
    deleteFunctionMessage: "确定要删除 Android 功能 \"{name}\" 吗？此操作将同时删除该功能下的所有子功能和测试数据，且无法恢复。",
    functionDeleteSuccess: "功能删除成功",
    functionDeleteFailed: "删除功能失败",
    bulkDeleteSuccess: "成功删除 {count} 个功能",
    bulkDeleteFailed: "批量删除失败",
    ...
    // 工具职责说明
    toolResponsibilities: {
      planner: "📋 android_planner - 生成测试计划",
      generator: "💻 android_generator - 生成测试代码",
      healer: "🔧 android_healer - 修复测试",
      executor: "🏃 run_tests - 执行测试"
    },
...
5. 保存测试成果到数据库`,
    ...
    aiGenerateFlow: {
      title: "AI 生成测试流程",
      steps: [
        { step: 1, action: "使用 android_planner 生成测试计划", tool: "android_planner" },
        { step: 2, action: "使用 save_test_plan 保存计划", tool: "save_test_plan" },
        { step: 3, action: "使用 android_generator 生成代码", tool: "android_generator" },
        { step: 4, action: "使用 save_test_script 保存代码", tool: "save_test_script" }
      ]
    },
    ...
    toolMapping: {
      ...
      tools: [
        {
          tool: "android_planner",
          purpose: "📋 生成测试计划",
          input: "应用信息路径",
          output: "测试计划文档（Markdown/JSON）",
          scenario: "上传应用信息后制定测试策略"
        },
        {
          tool: "android_generator",
          purpose: "💻 生成测试代码",
          input: "应用信息路径",
          output: "测试脚本（TypeScript/JavaScript）",
          scenario: "需要可执行的测试代码"
  ...
  pentest: {
    ...
    deleteReportConfirm: "确定要删除此报告吗？此操作不可撤销。",
    scanConfig: "扫描配置",
    createFailed: "创建失败",
    deleteConfirm: "确定删除此渗透测试任务吗？",
  },
...
// FIXME  Mi8zOmFIVnBZMlhsaUpqbWxvYzZXVzl2TWc9PTphY2JkMGVhZg==
