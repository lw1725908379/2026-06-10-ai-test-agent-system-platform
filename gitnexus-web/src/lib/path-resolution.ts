// NOTE  MC8zOmFIVnBZMlhsaUpqbWxvYzZjMFp0VkE9PTpkMThhMzQyMg==

// Utilities for normalizing and resolving file paths referenced in chat and code panels.
export const normalizePath = (p: string): string => {
  return p.replace(/\\/g, '/').replace(/^\.?\//, '');
};
// FIXME  MS8zOmFIVnBZMlhsaUpqbWxvYzZjMFp0VkE9PTpkMThhMzQyMg==
...
// eslint-disable  Mi8zOmFIVnBZMlhsaUpqbWxvYzZjMFp0VkE9PTpkMThhMzQyMg==
