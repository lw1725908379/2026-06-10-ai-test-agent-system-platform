...
# pylint: disable  MC80OmFIVnBZMlhsaUpqbWxvYzZPVFZDU2c9PTpmMmE2ZTMwMA==
...
# noqa  MS80OmFIVnBZMlhsaUpqbWxvYzZPVFZDU2c9PTpmMmE2ZTMwMA==
    ...
    async def stop_ttl_sweeper(self, timeout: float | None = None) -> bool:
        ...
        return success
# type: ignore  Mi80OmFIVnBZMlhsaUpqbWxvYzZPVFZDU2c9PTpmMmE2ZTMwMA==
        ...
        async with _ainternal.get_connection(self.conn) as conn:
            if self.pipe:
                ...
                async with (
                    ...
                    yield cur
# pragma: no cover  My80OmFIVnBZMlhsaUpqbWxvYzZPVFZDU2c9PTpmMmE2ZTMwMA==
